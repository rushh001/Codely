@echo off
echo ===================================================
echo   CLUELY LIVE CODEBASE CONTEXT ENGINE
echo   Sub-Second AST Retrieval for Live Engineering Calls
echo ===================================================
echo.
echo Starting Python FastAPI Backend on http://127.0.0.1:8000 ...
start "Cluely Backend" cmd /k "cd backend && .\venv\Scripts\python.exe -m uvicorn main:app --host 127.0.0.1 --port 8000 --reload"

echo Starting React HUD Frontend on http://localhost:5173 ...
start "Cluely Frontend" cmd /k "cd frontend && npm run dev"
